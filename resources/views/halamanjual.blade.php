...
@section('content')
    <div class="my-20 w-full">
        ...
        <p class="text-3xl text-black text-left m-5 ml-20 font-extrabold font-poppins ">
                ...
                <div id="defaultModal" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                        ...
                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-white-300 sm:p-5">
                            ...
                            <!-- Modal body -->
                            <form action="/simpan-jual" method="post">
                                @csrf
                                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                    <div>
                                        ...
                                        <input type="text" name="name" id="name"
                                            ...
                                            placeholder="nama Penjual" required="">
                                    </div>
                                    ...
                                    <div>
                                        <label for="pengiriman"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Cara
                                            Pengiriman</label>
            ...
            <a>
        <p>
            <p class="text-3xl text-black text-left font-extrabold font-poppins ml-20">
                2. Mengirim/Mengantar Jual</p>
            <pre class="text-1xl text-[#505F98] text-justify font-bold font-poppins">
        Bisa mengirim atau mengantar Jual yang telah disiapkan ke <a href="https://www.google.co.id/maps/search/Universitas+Syiah+Kuala/@5.5694652,95.3660805,17z/data=!3m1!4b1" class="underline"><i>alamat tujuan</i></a>
        (Harap cantuman nama dan No.hp di paket Jual)
            ...
            <p class="text-3xl text-black text-left  ml-20 font-extrabold font-poppins ">
                4. Akan mendapatkan konfirmasi jika barang sudah diterima<br>
            <p>

            <p class="text-3xl text-black text-left  ml-20 font-extrabold font-poppins ">
            <br>5. Keterangan Jual</p>
            <pre class="mt-5 text-1xl text-[#505F98] text-justify font-bold font-poppins">
            a. Barang yang dijual bisa berupa pakaian, barang, atau alat yang sekiranya "TIDAK LAYAK PAKAI"
            b. Barang yang sudah dikirim, nantinya akan diberikan kepada pihak yang bersangkutan
            c. Terkait info penjualan, akan dikonfirmasi/dikabari via website
            d. Setiap kali melakukan jual, maka anda akan mendapatkan 5 koin
            </pre>
