...
<div class="my-20 w-full">
    ...
    <h1 class="text-5xl text-black text-center font-extrabold font-poppins "><br>Prosedure Jual Limbah Tekstil Sipete</h1>
...
<!-- Modal toggle -->
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-white-300 sm:p-5">
                    ...
                    <form action="#">
                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                            <div>
                                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Nama Pengirim</label>
        ...
        <a>
    <h1 class="text-3xl text-black text-left font-extrabold font-poppins ml-20">2. Mengirim/Mengantar Limbah Tekstil
    </h1>
    <pre class="text-1xl text-[#505F98] text-justify font-bold font-poppins">
        Bisa mengirim atau mengantar limbah tekstil yang telah disiapkan ke alamat tujuan
        (Harap cantuman nama dan No.hp di paket limbah tekstil)
    </pre>
